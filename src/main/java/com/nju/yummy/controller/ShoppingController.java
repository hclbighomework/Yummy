...
public class ShoppingController {
    ...
    public Map<String, Object> getShoppingInfo(@RequestParam Map<String, Object> map, HttpServletRequest request) {
        ...
        if (members != null) {
            ...
            Restaurants restaurants = restaurantService.getRestaurantByName(name);
    ...
    public Map<String, Object> singleSorted(@RequestParam Map<String, Object> map) {
        ...
        Restaurants restaurants = restaurantService.getRestaurantByName(name);
        Map<String, Object> res = new HashMap<>();
        res.put("singleList", singleService.getSortedValidSinglesForRid(restaurants.getRid(), sortType));
        return res;
    }
    ...
    public Map<String, Object> packageSorted(@RequestParam Map<String, Object> map) {
        ...
        Restaurants restaurants = restaurantService.getRestaurantByName(name);
        Map<String, Object> res = new HashMap<>();
        res.put("packageList", packageService.getSortedValidPackagesForRid(restaurants.getRid(), sortType));
        return res;
    }
    ...
    public Map<String, Object> getPackageInfo(@RequestParam Map<String, Object> map) {
        ...
        Restaurants restaurants = restaurantService.getRestaurantByName(rName);
    ...
    @ResponseBody
    public Map<String, Object> setOrder(String[] singleName, int[] singleNum, String[] packageName, int[] packageNum, String rName, String note, double cost, HttpServletRequest request) {
        Map<String, Object> res = new HashMap<>();
        HttpSession session = request.getSession(false);
        if (session == null || !session.getAttribute("type").equals("member")) {
            res.put("message", "error");
        ...
        if (members != null) {
            ...
            order.setRid(restaurants.getRid());
            ...
            if (singleName != null && singleName.length > 0) {
                for (int i = 0; i < singleName.length; i++) {
                    ...
                    Singles singles = singleService.getSingleByNameAndRid(singleName[i], restaurants.getRid());
            ...
            if (packageName != null && packageName.length > 0) {
                for (int i = 0; i < packageName.length; i++) {
                    Packages packages = packageService.getPackageByNameAndRid(packageName[i], restaurants.getRid());
